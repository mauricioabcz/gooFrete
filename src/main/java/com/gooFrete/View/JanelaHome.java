...
public class JanelaHome extends javax.swing.JPanel {
    ...
    public JanelaHome() {
        ...
        resetColor(new JPanel[]{btn_2,btn_JanelaCadastros,btn_4}, new JPanel[]{ind_2,ind_3, ind_4});
    }
    ...
    private void btn_2MouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_2MouseReleased
        ...
        resetColor(new JPanel[]{btn_1,btn_JanelaCadastros,btn_4, btn_5}, new JPanel[]{ind_1,ind_3, ind_4, ind_5});
    ...
    private void btn_5MouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_5MouseReleased
        ...
        resetColor(new JPanel[]{btn_1,btn_JanelaCadastros,btn_4, btn_2}, new JPanel[]{ind_1,ind_3, ind_4, ind_2});
